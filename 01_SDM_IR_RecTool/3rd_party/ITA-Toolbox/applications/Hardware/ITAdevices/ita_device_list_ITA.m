...
device(end+1,:) = { 'GRAS Mic 1/2 40AF ITA-G1209','0.05 V/Pa','none',1}; % manufacturer data

% the following values are measured using the B&K type 4231 sound
% calibrator in combination with the adapter suitable for the KE4 microphones
% calibrated by HBR (06.02.2024) - all values updated except for KE4-23 & KE4-24
device(end+1,:) = { 'KE4-S04-001','0.008508313 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-002','0.009138751 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-003','0.010062761 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-004','0.008351222 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-005','0.008020328 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-006','0.009799930 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-007','0.009587995 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-008','0.008886593 V/Pa','ke4',1};

device(end+1,:) = { 'KE4-S04-009','0.009980430 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-010','0.009387993 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-011','0.010689593 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-012','0.010684832 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-013','0.010518272 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-014','0.009519441 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-015','0.010410739 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-016','0.011948987 V/Pa','ke4',1};

device(end+1,:) = { 'KE4-S04-017','0.011435852 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-018','0.007823403 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-019','0.009692481 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-020','0.009694706 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-021','0.010410249 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-022','0.010465307 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-023','0.010242 V/Pa','ke4',1}; % not updated yet
device(end+1,:) = { 'KE4-S04-024','0.01151 V/Pa','ke4',1}; % not updated yet

device(end+1,:) = { 'KE4-S04-025','0.009942006 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-026','0.008983886 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-027','0.010189482 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-028','0.008862374 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-029','0.010757175 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-030','0.008388275 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-031','0.011177853 V/Pa','ke4',1};
device(end+1,:) = { 'KE4-S04-032','0.009863688 V/Pa','ke4',1};
...
% (re-)calibrated by LAS (19.02.2024)
device(end+1,:) = { 'ITA-KK I "Analog" left - calibrator','0.014679 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK I "Analog" right - calibrator','0.015814 V/Pa','schoeps',1};
...
device(end+1,:) = { 'ITA-KK I "Analog" left - free-field meas','0.014646 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK I "Analog" right - free-field meas','0.01548 V/Pa','schoeps',1};

% the following values are measured using the B&K type 4231 sound
% calibrator in combination with the adapter suitable for the Schoeps CCM 2 H capsules
% calibrated by LAS (19.02.2024)
device(end+1,:) = { 'ITA-KK II "Digital" left','0.014401 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK II "Digital" right','0.013486 V/Pa','schoeps',1};

% the following values are measured using the B&K type 4231 sound
% calibrator in combination with the adapter suitable for the KE4 microphones
% calibrated by LAS (20.02.2024)
device(end+1,:) = { 'ITA-KK III "ScienceTruck" left','0.0074104 V/Pa','ke4',1};
device(end+1,:) = { 'ITA-KK III "ScienceTruck" right','0.0069383 V/Pa','ke4',1};
device(end+1,:) = { 'ITA-KK IV "HearingAid" left','0.0069814 V/Pa','ke4',1};
device(end+1,:) = { 'ITA-KK IV "HearingAid" right','0.0074332 V/Pa','ke4',1};

% the following values are measured using the B&K type 4231 sound
% calibrator in combination with the adapter suitable for the Schoeps CCM 2 H capsules
% calibrated by LAS (20.02.2024)
device(end+1,:) = { 'ITA-KK V "IBP" left','0.016065 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK V "IBP" right','0.015474 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK VI "PTB" left','0.017731 V/Pa','schoeps',1};
device(end+1,:) = { 'ITA-KK VI "PTB" right','0.018054 V/Pa','schoeps',1};

device(end+1,:) = { 'ITA-KK KE4 Child left','0.0091581 V/Pa','ke4',1};
device(end+1,:) = { 'ITA-KK KE4 Child right','0.0098573 V/Pa','ke4',1};
...
device(end+1,:) = { 'NONE','1 ','none',0};
device(end+1,:) = { 'UNKNOWN','1 ','none',1};
device(end+1,:) = { 'ITA Dode 04/2007 Two-way ','1 Pa m/V','ita_dode',1};
device(end+1,:) = { 'ITA Dode 05/2007 Two-way ','1 Pa m/V','ita_dode',1};
device(end+1,:) = { 'ITA Dode 04/2007 Three-way ','1 Pa m/V','ita_dode',1};
device(end+1,:) = { 'ITA Dode 05/2007 Three-way ','1 Pa m/V','ita_dode',1};

device(end+1,:) = { 'Behringer Eurolive B212D #1','1 Pa m/V','ita_dode',1};
device(end+1,:) = { 'Behringer Eurolive B212D #2','1 Pa m/V','ita_dode',1};
