...
%% check Sofa version is sufficiently up to date
sofaVersion = SOFAgetVersion;
if str2double(sofaVersion(1:3))< 2.2
    error('SOFA version outdated. Run ita_sofa_update and try again');
end
